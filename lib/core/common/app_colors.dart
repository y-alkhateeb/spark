...
class AppColors{
  ...
  static const Color primaryColor = Color(0xFF4276de);
  static const Color primaryColorDark = Color(0xFFabb2bf);

  static const Color accentColor = Color(0xFF3f62ac);
  static const Color accentLightColor = Color(0xFF53ac6d);
  ...
  static const Color backgroundColor = Color(0xFF21252b);
  static const Color termsBackgroundColor = Color(0xFFebf5f7);
  static const Color backgroundDarkColor = Color(0xFF21252b);
