...
//
//    final Map<String, String> core.params = <String, String>{};
//    core.params['refresh_token'] = SpUtil.getString(Constant.refreshToken);
//    try {
//      _tokenDio.options = DioUtils.instance.dio.options;
//      final Response response = await _tokenDio.post('lgn/refreshToken', data: core.params);
